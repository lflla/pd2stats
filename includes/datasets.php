...
array( 'Name' => $l['transport-harbor'], 'Image' => 'transport-harbor', 'Win' => $contract_arm_fac_win, 'Dropin' => $contract_arm_fac_win_dropin, 'Fail' => $contract_arm_fac_fail, 'Quality' => 'dlc', 'deathwish' => $death_22),
array( 'Name' => $l['transport-park'], 'Image' => 'transport-park', 'Win' => $contract_arm_par_win, 'Dropin' => $contract_arm_par_win_dropin, 'Fail' => $contract_arm_par_fail, 'Quality' => 'dlc', 'deathwish' => $death_23),
array( 'Name' => $l['transport-downtown'], 'Image' => 'transport-downtown', 'Win' => $contract_arm_hcm_win, 'Dropin' => $contract_arm_hcm_win_dropin, 'Fail' => $contract_arm_hcm_fail, 'Quality' => 'dlc', 'deathwish' => $death_21),
array( 'Name' => $l['transport-underpass'], 'Image' => 'transport-underpass', 'Win' => $contract_arm_und_win, 'Dropin' => $contract_arm_und_win_dropin, 'Fail' => $contract_arm_und_fail, 'Quality' => 'dlc', 'deathwish' => $death_24),
array( 'Name' => $l['transport-crossroads'], 'Image' => 'transport-crossroads', 'Win' => $contract_arm_cro_win, 'Dropin' => $contract_arm_cro_win_dropin, 'Fail' => $contract_arm_cro_fail, 'Quality' => 'dlc', 'deathwish' => $death_20),
...
array( 'Name' => $l['e-tank_gensec'], 'Wiki' => '', 'Description' => '', 'Value' => $enemy_kills_tank_gensec ),
