...
array( 'Name' => $l['nightmare'], 'Wiki' => 'Safe_House_Nightmare', 'Image' => 'nightmare', 'Win' => $contract_haunted_win, 'Dropin' => $contract_haunted_win_dropin, 'Fail' => $contract_haunted_fail, 'Quality' => 'event'),
...
if ($skill_fugitive_freedom_call == 1 || $skill_fugitive_hidden_blade == 1 || $skill_fugitive_thick_skin == 1){$skill_fugitive_unlocked = 1;};

$fugitive = array(
array( 'Name' => $l['bullseye'], 'Wiki' => 'Bullseye', 'Image' => 'Bullseye', 'Description-Normal' => $l['bullseye-normal'], 'Description-Ace' => $l['bullseye-ace'], 'Normal' => $skill_fugitive_prison_wife, 'Ace' => $skill_fugitive_prison_wife_ace ),
array( 'Name' => $l['sneakybastard'], 'Wiki' => 'Sneaky_Bastard', 'Image' => 'Sneaky_Bastard', 'Description-Normal' => $l['sneakybastard-normal'], 'Description-Ace' => $l['sneakybastard-ace'], 'Normal' => $skill_fugitive_jail_diet, 'Ace' => $skill_fugitive_jail_diet_ace ),
array( 'Name' => $l['akimbo'], 'Wiki' => 'Akimbo', 'Image' => 'Akimbo', 'Description-Normal' => $l['akimbo-normal'], 'Description-Ace' => $l['akimbo-ace'], 'Normal' => $skill_fugitive_akimbo, 'Ace' => $skill_fugitive_akimbo_ace ),
array( 'Name' => $l['triggerhappy'], 'Wiki' => 'Trigger_Happy', 'Image' => 'Trigger_Happy', 'Description-Normal' => $l['triggerhappy-normal'], 'Description-Ace' => $l['triggerhappy-ace'], 'Normal' => $skill_fugitive_trigger_happy, 'Ace' => $skill_fugitive_trigger_happy_ace ),
array( 'Name' => $l['lowblow'], 'Wiki' => 'Low_Blow', 'Image' => 'Low_Blow', 'Description-Normal' => $l['lowblow-normal'], 'Description-Ace' => $l['lowblow-ace'], 'Normal' => $skill_fugitive_backstab, 'Ace' => $skill_fugitive_backstab_ace ),
array( 'Name' => $l['counterstrike'], 'Wiki' => 'Counter-Strike', 'Image' => 'Counter-Strike', 'Description-Normal' => $l['counterstrike-normal'], 'Description-Ace' => $l['counterstrike-ace'], 'Normal' => $skill_fugitive_drop_soap, 'Ace' => $skill_fugitive_drop_soap_ace ),
array( 'Name' => $l['swansong'], 'Wiki' => 'Swan_Song', 'Image' => 'Swan_Song', 'Description-Normal' => $l['swansong-normal'], 'Description-Ace' => $l['swansong-ace'], 'Normal' => $skill_fugitive_perseverance, 'Ace' => $skill_fugitive_perseverance_ace ),
array( 'Name' => $l['undertaker'], 'Wiki' => 'Undertaker', 'Image' => 'Undertaker', 'Description-Normal' => $l['undertaker-normal'], 'Description-Ace' => $l['undertaker-ace'], 'Normal' => $skill_fugitive_second_chances, 'Ace' => $skill_fugitive_second_chances_ace ),
array( 'Name' => $l['uppers'], 'Wiki' => 'Uppers', 'Image' => 'Uppers', 'Description-Normal' => $l['uppers-normal'], 'Description-Ace' => $l['uppers-ace'], 'Normal' => $skill_fugitive_tea_cookies, 'Ace' => $skill_fugitive_tea_cookies_ace ),
array( 'Name' => $l['brotherskeeper'], 'Wiki' => 'Brother&apos;s_Keeper', 'Image' => 'Brothers_Keeper', 'Description-Normal' => $l['brotherskeeper-normal'], 'Description-Ace' => $l['brotherskeeper-ace'], 'Normal' => $skill_fugitive_cell_mates, 'Ace' => $skill_fugitive_cell_mates_ace ),
array( 'Name' => $l['winstonwolfe'], 'Wiki' => 'Winston_Wolfe', 'Image' => 'Winston_Wolfe', 'Description-Normal' => $l['winstonwolfe-normal'], 'Description-Ace' => $l['winstonwolfe-ace'], 'Normal' => $skill_fugitive_thug_life, 'Ace' => $skill_fugitive_thug_life_ace ),
array( 'Name' => $l['quickfix'], 'Wiki' => 'Quick_Fix', 'Image' => 'Quick_Fix', 'Description-Normal' => $l['quickfix-normal'], 'Description-Ace' => $l['quickfix-ace'], 'Normal' => $skill_fugitive_tea_time, 'Ace' => $skill_fugitive_tea_time_ace ),
array( 'Name' => $l['runandgun'], 'Wiki' => 'Run_And_Gun', 'Image' => 'Run_And_Gun', 'Description-Normal' => $l['runandgun-normal'], 'Description-Ace' => $l['runandgun-ace'], 'Normal' => $skill_fugitive_awareness, 'Ace' => $skill_fugitive_awareness ),
array( 'Name' => $l['sixthsense'], 'Wiki' => 'Sixth_Sense', 'Image' => 'Sixth_Sense', 'Description-Normal' => $l['sixthsense-normal'], 'Description-Ace' => $l['sixthsense-ace'], 'Normal' => $skill_fugitive_jail_workout, 'Ace' => $skill_fugitive_jail_workout_ace ),
array( 'Name' => $l['duckandcover'], 'Wiki' => 'Duck_And_Cover', 'Image' => 'Duck_And_Cover', 'Description-Normal' => $l['duckandcover-normal'], 'Description-Ace' => $l['duckandcover-ace'], 'Normal' => $skill_fugitive_alpha_dog, 'Ace' => $skill_fugitive_alpha_dog_ace ),
array( 'Name' => $l['daredevil'], 'Wiki' => 'Daredevil', 'Image' => 'Daredevil', 'Description-Normal' => $l['daredevil-normal'], 'Description-Ace' => $l['daredevil-ace'], 'Normal' => $skill_fugitive_freedom_call, 'Ace' => $skill_fugitive_freedom_call_ace ),
array( 'Name' => $l['hiddenblade'], 'Wiki' => 'Hidden_Blade', 'Image' => 'Hidden_Blade', 'Description-Normal' => $l['hiddenblade-normal'], 'Description-Ace' => $l['hiddenblade-ace'], 'Normal' => $skill_fugitive_hidden_blade, 'Ace' => $skill_fugitive_hidden_blade_ace ),
array( 'Name' => $l['thickskin'], 'Wiki' => 'Thick_Skin', 'Image' => 'Thick_Skin', 'Description-Normal' => $l['thickskin-normal'], 'Description-Ace' => $l['thickskin-ace'], 'Normal' => $skill_fugitive_thick_skin, 'Ace' => $skill_fugitive_thick_skin_ace ),
array( 'Name' => $l['unlockfugitive'], 'Wiki' => 'Skills#Fugitive', 'Image' => 'Unlocking_the_Fugitive', 'Description-Normal' => $l['unlockfugitive-normal'], 'Description-Ace' => '', 'Normal' => $skill_fugitive_unlocked, 'Ace' => '' )
);
