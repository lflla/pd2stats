...
$l['title-full'] = 'Payday 2 Statisztikák';
$l['meta-description'] = 'Üdv a Payday 2 Statisztikáknál, egy könnyű út a játékos statisztikák megnézéséhez.';
$l['meta-language'] = 'Magyar';
$l['meta-keywords'] = 'Payday 2, Profilok, Statisztikák, pd2stats.com';
//Index and Search
$l['welcome'] = 'Üdv a Payday 2 Statisztikáknál!';
$l['search-txt'] = 'Keresés';
$l['search-msg'] = 'Kérlek írj be egy steam profil linket, egy egyéni profil id-t vagy egy profil számot.';
$l['search-button'] = 'Vezess oda!';
//Menu
$l['steamgroup'] = 'Steam Csoport';
$l['feedback'] = 'Visszajelzés';
$l['notice'] = 'Megjegyzés';
//Tags and Warnings
$l['cflag'] = '[Csaló]';
$l['cflag-warning'] = 'Címkék nem mindig pontosak mivel a játék szint és skill bugokat tartalmaz.';
$l['pflag'] = '[Családi Megosztás]';
$l['pflag-warning'] = 'Ez a címke azt jelenti, higy a játékos nem tulajdonosa a játéknak.';
$l['hflag'] = '[Rejtett]';
$l['sflag'] = '[Gyanús]';
$l['level-warning'] = 'Pillanatnyilag a játékos-szint néha nem pontos. Overkill dolgozik rajta.';
//Item Quality Texts
$l['community-item'] = 'EZ EGY KÖZÖSSÉGI TÁRGY!';
$l['dlc-item-start'] = 'EZ EGY';
$l['dlc-item-end'] = 'TÁRGY!';
$l['infamous-item'] = 'EZ EGY INFAMOUS TÁRGY!';
$l['custom-item'] = 'EZ EGY EGYÉNI TÁRGY, KÉSZÍTETTE:';
//Errors
$l['error-text1'] = 'ID használaton kívül!';
$l['error-text2'] = 'ÉN LENNI HIBA';
$l['error-text3'] = 'Steam nem válaszolt időben!';
$l['error-text4'] = 'Nincs keresési bemenet';
$l['error-text5'] = 'Nincs Profil Szám jelen';
$l['error'] = 'Hiba';
$l['error-start'] = 'Valami rosszil sikerült de bármikor';
$l['error-mid'] = 'újra próbálkozhatsz';
$l['error-end'] = 'Beírhatsz egy steam profil linket, egy egyéni profil id-t vagy egy profil számot.';
//Profile
$l['meta-private'] = 'privátra állította steam profilját és csak alap információ van mutatva.';
$l['steam-link'] = 'Steam Link';
$l['profile-link'] = 'Profil Link';
//Feedback
$l['question-box'] = 'Visszajelzés Kérdések';
$l['feedback-meta'] = 'Ez az a hely ahol visszajelzést hagyhatsz a Payday 2 Statisztikákról.';
//Stats Page
$l['comments'] = 'Megjegyzések';
$l['comments-no-script'] = 'Kérlek engedélyezd JavaScript-et hogy ezt megnézhesd:';
$l['comments-powered'] = 'Megjegyzéseket üzemeli';
$l['tips'] = 'Tippek';
$l['tips-start'] = 'Tudtad hogy steam profil linkkel is működik az oldal mint például:';
$l['tips-mid'] = 'És áthelyezni az url részt?';
$l['credits'] = 'Készítők';
$l['skilltrees'] = 'Képességfák';
$l['skilltrees-help'] = 'Ez a játékos felépítése amit akkor használt mikor az adatokat elküldték a játékból a steamhez. Néha a azt írja, hogy a játékos az összes tehetségpontot birtokolja. Pillanatnyilag ismeretlen, mi okozza ezt a hibát. Azonban HoxHud használható a tehetség adatok újraérvényesítéséhez. Csak telepíts és ellenőrizd újra. Azt is jegyezd meg hogy az elérhető tehetségpontok talán hibásak néha az eltolt szint bug miatt.';
...
$l['hours'] = 'Óra';
$l['minutes'] = 'Perc';
$l['level'] = 'Payday 2 Szint:';
$l['playtime'] = 'Játékidő';
$l['skillpoints'] = 'Tehetségpontok';
$l['skillpoints8'] = 'Tehetségpontok';
$l['skillpoint'] = 'Tehetségpont';
$l['basic'] = 'Alap';
$l['ace'] = 'Ász';
$l['unlock'] = 'Unlock for';
$l['basics'] = 'Alapok';
$l['basics-help'] = 'Ez a nap adat. Ez követi az adatait körülbellül a GO Bank Frissítés óta. A kimutatott számláló mutatja a napokat menekülésekkel együtt. Ez azt jelenti, hogy jelenleg számolja asikeres és sikertelen napokat.';
$l['risk'] = 'Nehézség';
$l['days-played'] = 'Játszott Napok';
$l['total-day-start'] = '';
$l['total-day-mid'] = 'sikeres és';
$l['total-day-end'] = 'sikertelen napok számolva.';
$l['heist'] = 'Rablások';
$l['heist-help'] = 'Ez a rablás adat. Ez követi az adatot #32.1. frissítés óta. Zöld a megnyert rablást, Sárga azokat a rablásokat, amibe elkezdés után csatlakozott és Vörös a sikertelen rablást jelöli. Az első százalék csak ezt a rablást használva számol és a másik meg az összes rablás százalékot használja.';
$l['sort'] = 'Rendezés';
$l['win'] = 'Nyert';
$l['dropin'] = 'Becsatlakozás';
$l['fail'] = 'Vesztett';
$l['escape'] = 'Menekülések';
$l['escape-help'] = 'Ez a Menekülés adat. Ez követi az adatait körülbellöl a GO Bank Frissítés óta. Ez azt jelenti, hogy jelenleg a sikeres és sikertelen napokat számolja.';
$l['total'] = 'Összes';
$l['masks'] = 'Maszkok';
$l['masks-help'] = 'Ez a Maszk adat. A maszk használata napokban van kimutatva, ebbe beleértődik sikeres, sikertelen és menekülési nap.';
$l['usage'] = 'Használat';
$l['name'] = 'Név';
$l['armors'] = 'Páncélzatok';
$l['armor'] = 'Páncél';
$l['armor-help'] = 'Ez a páncél adat. Ez követi az adatait #32.1. frissítés óta. A szám napokat mutat, beleértve a meneküléseket is. Ez azt jelenti, hogy jelenleg számolja a sikeres és sikertelen napokat is.';
$l['times-used'] = 'Ennyiszer használva';
$l['concealment'] = 'Leplezés';
$l['speed'] = 'Sebesség';
$l['dodge'] = 'Kitérés';
$l['steadiness'] = 'Kitartás';
$l['stamina'] = 'Enegria';
$l['gadgets'] = 'Eszközök';
$l['gadgets-help'] = 'Ez az eszköz adat. Ez követi az adatait körülbellül a GO Bank Frissítés óta. A számláló mutatja, mennyi eszközt raktak le.';
$l['weapons'] = 'Fegyverek';
...
$l['melee'] = 'Közelharc';
$l['kills'] = 'Ölések';
$l['percent-kills'] = '% az összes Ölésből';
$l['magazine'] = 'Tár';
$l['ammo'] = 'Összes Lőszer';
$l['firerate'] = 'Tűzgyorsaság';
$l['damage'] = 'Sebzés';
$l['accuracy'] = 'Célzás';
$l['stability'] = 'Stabilitás';
$l['threat'] = 'Rajtaütés';
$l['knockdown'] = 'Leütés';
$l['chargetime'] = 'Töltési Idő';
$l['range'] = 'Hatótávolság';
$l['infinite'] = '∞';
$l['playername'] = 'Játékosnév';
$l['tops'] = 'Legtöbbször Megnézett Profilok';
$l['totalview'] = 'Összes Megnézés';
//DLC Names
...
////Melee
$l['butt'] = 'Fegyver Tusa';
$l['butt-description'] = 'Fegyveres rablásoknál, lőfegyverekkel legsűrűbben inkább lőnek áldozatokra, minthogy leütnék őket. Te általában valakit letusázol puskáddal vagy pisztoly-ostorozod egy pisztollyal.<br/><br/>Ez a leggyorsabb közelharci támadás.';
$l['fists'] = 'Öklök';
$l['fists-description'] = 'Nem vagy boxoló, de még így is leadhatsz pár jó ütést. Csak energia, sebesség és időzítés kell hozzá és egyből leadsz egy ötő csapást seperc alatt.';
$l['brass_knuckles'] = '350K Bokszer';
$l['brass_knuckles-description'] = 'Bokszer stílusú fegyvereket évszázadok óta használnak. A bokszer az ütést egy nehezedd és kissebb területre kényszeríti, megnövelve az esélyt a szövet szakadására. Ha elég erősen ütsz, talán még csontokat is törsz vele.';
$l['moneybundle'] = 'Pénzköteg';
$l['moneybundle-description'] = 'Összekötni pénzt egy szalaggal olyan régi mint maga a pénz. Rendőrséget verni pénzel az valami olyan dolog, amit gazdag emberek csinálnak egy jó ideje.';
$l['barbedwire'] = 'Baseball Ütő';
$l['barbedwire-description'] = 'Egy baseball ütő amivel haza-futásokat üthetsz.';
$l['kabar'] = 'URSA Kés';
$l['kabar-description'] = 'Az URSA Kés egy strapabíró, elpusztíthatatlan harci/hasznossági kés 1942 ből. Bowie penge, fogazott él, semmi képtelenség. Egy klasszikus.';
$l['kampfmesser'] = 'Krieger Penge';
$l['kampfmesser-description'] = 'A Krieger Penge a Német Katonaság alap kése. Nagy fogás és a Tanto penge kitűnő választássá teszi küzdelemre.';
$l['gerber'] = 'Berger Harci Kés';
$l['gerber-description'] = 'A Berger Harci Kés egy nagyon híres taktikus kés, összecsukható kapcsos pengével. Kompakt, könnyű és high-tech anyagok gyors és veszélyes eszközzé teszik.';
$l['rambo'] = 'Trautman Kés';
$l['rambo-description'] = 'A Trautman egy túlélő kés nehéz Bowie pengével. A hosszúság, fogazott gerinc és a középpontú csúcsa olyan jól működik a vadonban, mint a közelharcban.';
$l['shovel'] = 'K.L.A.S. Ásó';
$l['shovel-description'] = 'A K.L.A.S. ásót többféle okokból használja a katonaság. Az ásó megtalálható túlélőknél, szabad-vezetőknél, táborozóknál, túrázóknál, kertészeknél és háborús rekonstruált csoportoknál. Fegyverként is használható - élezd meg a széleket amivel húson és csonton fogsz átvágni. Persze ha jól használod. Amit nem fogsz.';
$l['baton'] = 'Teleszkópos Gumibot';
$l['baton-description'] = 'Minden rabló és rendőr kedvenc fegyvere tömegoszlatásra és nem megfelelő emberek szétszórására.Számos előnye van a fixált gumibottal szemben a bővíthető gumibotnak. Könnyű és hatékony, sokoldalúbb és félelmetesebb más potenciális támadóval szemben.';
$l['tomahawk'] = 'Túlélő Tomahawk';
$l['tomahawk-description'] = 'Történelmileg általános célokra használták, például emberek felé dobni és alkalmankét kézről-kézre játó közelharci fegyvernek használni. A fegyver amivel majdnem minden szintű kezdő eléri a jártasság valamelyik fokát. Csak a megfelelő rabláson át lehet elkezdeni felfogni, hogy eszközként és fegyverkén is lehet a tomahawkot használni. De legtöbbször fegyverként.';
$l['becker'] = 'Használati Macséta';
$l['becker-description'] = 'A Macséta egy nagy bárd-szerű kés, gyakran használva trópikus országokban esőerdők átvágására, lázadásokra és mezőgazdasági célokra. Gyakran látható embereket macsétákat használni más munkákra is, például kókuszdiót, koponyát félbevágni, udvari munkát végezni és bankot rabolni.';
$l['bayonet'] = 'Szurony';
$l['bayonet-description'] = 'A bepattintható Szurony egy harctéri klasszikus. Eredetileg arra lett kitalálva, hogy a fegyveredre rakod, hogy lándzsaként használhasd, de ez a kicsike helyette a zsebedben jár és kijön mikor elkezdesz vele hadonászni CQB-stílusra.';
$l['bullseye'] = 'Kompakt Fejsze';
$l['bullseye-description'] = 'A Kompakt Fejsze egy fejsze ami egy kovácsolt sebészeti acélból áll egy gumizott markolattal.<br/><br/>Nem is tudom mint mondjak őszintén - ez nem valami amit harcba vinnél, kivéve a valamiféle őrült vagy, ugye? Úgy értem, ez arra van kitalálva, hogy fát vágjanak vele és táborozni vigyék, nem pedig bankrablásra használni. Ugye?';
$l['x46'] = 'X-46 Kés';
$l['x46-description'] = 'Az X-46 Kés egy 6\'\' hosszú fedett, A2 acél, egy részben fogazott bowie penge, hamis véggel konfigurálva. Integrált őr és üveg törő csúccsal. A kés többhasználatú terep dizájnja teszi olyan hasznossá a harcterepen mint egy vészhelyzetben.';
$l['dingdong'] = 'Ding Dong Faltörő';
$l['dingdong-description'] = 'A Ding Dong Faltörő alapból egy faltörő kalapács. Eredetileg betörési eszközként, faltörő kosként használják, feszítővassal egybevonva. Úgy gondolom legtöbbször fejek felnyitására fogod használni. Hatalmas sebzés és leütés, de relatívan lassú.';
////Grenades
$l['frag-grenade'] = 'Repeszgránát';
////Gadgets
$l['ammo_bag'] = 'Lőszeres zsák';
$l['ammo_bag-description'] = 'A lőszeres zsák egy hordozható zsák, eredetileg arra tervezve, hogy katonák hordozhassanak benne extra muníciót.';
$l['doctor_bag'] = 'Orvosi zsák';
$l['doctor_bag-description'] = 'Az orvosi zsák egy hordozható zsák, mit általában egy orvos vagy más orvosi haladó hordoz, benne orvosi felszereléssel és gyógyszerrel.';
...
$l['sentry_gun'] = 'Őrtorony';
$l['sentry_gun-description'] = 'Az őrtorony egy fegyver, ami autómatikusan olyan ellenségre céloz és lőm, akiket szenzorok észlelnek. Történelmileg, katonai őrtornyok ellenséges közelgő rakéták és repülőgépek észlelésére és elpusztítására lettek kitalálva.';
$l['ecm_jammer'] = 'ECM';
$l['ecm_jammer-description'] = 'Az elektromos ellenintézkedő (ECM) egy elektromos eszköz, ami radarok, szonárok és egyéb észlelő rendszerek megzavarására lett tervezve.';
////Armor
$l['level_1'] = 'Két-Darabos Öltöny';
...
$l['level_2'] = 'könnyűsúlyú Ballistikus Mellény';
...
$l['level_4'] = 'Nehéz Ballistikus Mellény';
...
$l['level_6'] = 'Kombinált Taktikus Mellény';
...
$l['level_7'] = 'Továbbfejlesztett Kombinált Taktikus Mellény';
...
//Escapes
$l['escapeparknight'] = 'Park (Éjjel)';
$l['escapeparkday'] = 'Park (Nappal)';
$l['escapecafenight'] = 'Kávézó (Éjjel)';
$l['escapecafeday'] = 'Kávézó (Nappal)';
$l['escapestreet'] = 'Utca';
$l['escapeoverpass'] = 'Felüljáró';
$l['escapegarage'] = 'Garázs';
////Skilltrees
//Mastermind
...
$l['crimefest-more'] = 'tag kell hogy feloldódjon';
$l['gage-gun'] = 'a Fegyver Gage Felszereléséből';
$l['gensec-enemy'] = 'az Ellenség a GenSec Biztonságiaktól';
$l['time-of-day'] = 'a Reggel/Este Rablás Variánsok';
$l['secret-unlock'] = 'a Titkos Cucc';
$l['nothing'] = 'a Semmi';