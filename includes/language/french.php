...
$l['search-msg'] = 'Entrez un lien de profil Steam, un id personnalisé ou un numéro de profil.';
...
//Errors
$l['error-text1'] = 'ID n\'on utilisé!';
$l['error-text2'] = 'JE SUIS UNE ERREUR';
$l['error-text3'] = 'Steam n\'a pas répondu!';
...
$l['comments-powered'] = 'commentaires fourni par';
$l['tips'] = 'Remarques';
