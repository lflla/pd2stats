...
////
// Language: French
// File written by: Blanche Neige
// Item descriptions identical with ingame text? Yes
////
$l['language'] = 'French';
$l['author'] = 'Blanche Neige';
...
$l['meta-description'] = 'Bienvenue sur Payday 2 Statistics, un moyen facile pour visualiser les statistiques de n\'importe quel joueur de Payday 2';
$l['meta-language'] = 'French';
$l['meta-keywords'] = 'Payday 2, Profil, Statistiques, pd2stats.com';
//Index and Search
$l['welcome'] = 'Bienvenue sur Payday 2 Statistics!';
$l['search-txt'] = 'Recherche';
$l['search-msg'] = 'Entrer un lien de profil Steam, un id personnalisé ou un numéro de profil.';
$l['search-button'] = 'Lancer la recherche';
//Menu
$l['steamgroup'] = 'Groupe Steam';
$l['feedback'] = 'FAQ';
...
$l['pflag'] = '[Mode Famille]';
$l['pflag-warning'] = 'signifie que le jeu n\'est pas détenu par le joueur.';
$l['hflag'] = '[Caché]';
$l['sflag'] = '[Suspect]';
$l['level-warning'] = 'Par moments le niveau du joueur n\'est pas tout à fait correct, Overkill travaille dessus.';
//Item Quality Texts
$l['community-item'] = 'C\'EST UN OBJET DE LA COMMUNAUTÉ!';
$l['dlc-item-start'] = 'C\'EST UN';
$l['dlc-item-end'] = 'OBJET!';
$l['infamous-item'] = 'C\'EST UN OBJET INFÂME!';
$l['custom-item'] = 'C\'EST UN OBJET PERSONNALISÉ FAIT PAR';
//Errors
$l['error-text1'] = 'ID non utilisé!';
$l['error-text2'] = 'JE SUIS UNE ERREUR';
$l['error-text3'] = 'Steam n\'a pas répondu assez vite!';
$l['error-text4'] = 'Il n\'y a rien à rechercher';
$l['error-text5'] =  'Pas de numéro de profil';
$l['error'] = 'Erreur';
$l['error-start'] = 'Quelque chose s\'est mal passé, mais vous pouvez toujours';
$l['error-mid'] = 'essayer à nouveau';
$l['error-end'] = 'Entrez un lien de profil Steam, un id personnalisé ou un numéro de profil.';
//Profile
$l['meta-private'] = 'a mis son profil en privé et seulement les informations de base sont montrées.';
$l['steam-link'] = 'Profil Steam';
$l['profile-link'] = 'Profil PD2stats';
//Feedback
$l['question-box'] = 'FAQ';
$l['feedback-meta'] = 'C\'est l\'endroit où faire un retour concernant Payday 2 Statistics.';
//Stats Page
$l['comments'] = 'Commentaires';
$l['comments-no-script'] = 'Activez JavaScript pour voir';
$l['comments-powered'] = 'commentaires fournsi par';
$l['tips'] = 'Remarques';
$l['tips-start'] = 'Savez-vous que vous pouvez aussi mettre un lien de profil Steam comme ceci :';
$l['tips-mid'] = 'Et remplacer l\'url ?';
$l['credits'] = 'Crédits';
$l['skilltrees'] = 'Compétences';
$l['skilltrees-help'] = 'Voici l\'arbre de talents que le joueur utilisait lorsque les données ont été récupérées. Parfois les points de compétences sont montrés comment étant tous utilisés. Ceci est un bug inconnu. Cependant HoxHud peut être utilisé pour revalider les compétences. Vous avez juste à l\'installer et faire un \'re-spec\'. Notez également que le total des points de compétences disponibles peut être erroné en fonction des prises de niveaux.';
$l['mastermind'] = 'Cerveau';
$l['technician'] = 'Technicien';
$l['ghost'] = 'Fantôme';
$l['enforcer'] = 'Exécuteur';
$l['hours'] = 'heures';
$l['minutes'] = 'minutes';
$l['level'] = 'Niveau Payday 2:';
$l['playtime'] = 'Temps de jeu';
$l['skillpoints'] = 'Points de talent';
$l['skillpoints8'] = 'Points de talent';
$l['skillpoint'] = 'Point de talent';
$l['basic'] = 'Base';
$l['ace'] = 'As';
$l['unlock'] = 'Débloqué pour';
$l['basics'] = 'Résumé';
$l['basics-help'] = 'Voici le résumé des casses depuis (à peu près) la mise à jour Go Bank. Le compte est affiché en jours et le total comprend également les évasions. C\'est à dire que sont comptés les réussites et les échecs.';
$l['risk'] = 'Risque';
$l['days-played'] = 'Jours joués';
$l['total-day-start'] = 'Pour un total de';
$l['total-day-mid'] = 'succès et';
$l['total-day-end'] = 'jours échoués.';
$l['heist'] = 'Casses';
$l['heist-help'] = 'Voici les données des casses effectués depuis la mise à jour #32.1. En vert les casses réussis, en jaune les casses rejoints en cours et réussis, enfin en rouge les casses échoués. Le premier pourcentage est calculé uniquement pour le casse actuel, et le second utilise tous les casses.';
$l['sort'] = 'Trier par';
$l['win'] = 'Succès';
$l['dropin'] = 'Rejoints en cours';
$l['fail'] = 'Échecs';
$l['escape'] = 'Évasions';
$l['escape-help'] = 'Voici les données des évasions depuis (à peu près) la mise à jour Go Bank. C\'est à dire que sont comptés les réussites et les échecs.';
$l['total'] = 'Total';
$l['masks'] = 'Masques';
$l['masks-help'] = 'Voici les données des masques. L\'utilisation des masques est comptée en jours, ceci inclut les échecs, les succès et les évasions.';
$l['usage'] = 'Utilisation';
$l['name'] = 'Nom';
$l['armors'] = 'Armures';
$l['armor'] = 'Armure';
$l['armor-help'] = 'Voici les données des armures utilisées depuis la mise à jour #32.1. L\'utilisation des armures est comptée en jours, ceci inclut les succès et les échecs.';
$l['times-used'] = 'Nombre d\'utilisations';
$l['concealment'] = 'Dissimulation';
$l['speed'] = 'Vitesse';
$l['dodge'] = 'Esquive';
$l['steadiness'] = 'Stabilité';
$l['stamina'] = 'Endurance';
$l['gadgets'] = 'Équipements';
$l['gadgets-help'] = 'Voici les données des équipements depuis (à peu près) la mise à jour Go Bank. Le compte affiche les équipements déployés.';
$l['weapons'] = 'Armes';
$l['weapons-help'] = 'Voici les données des armes. Les kills sont comptabilisés depuis la mise à jour #32.1 et l\'utilisation des armes depuis \(à peu près\) la mise à jour Go Bank. L\'utilisation des armes de mêlée est comptabilisée depuis la mise à jour #31.2. L\'utilisation est affichée en jours, ceci inclut les échecs, les succès et les évasions.';
$l['primary'] = 'Principales';
$l['secondary'] = 'Secondaires';
$l['melee'] = 'Mêlée';
$l['kills'] = 'Kills';
$l['percent-kills'] = '% du total de Kills';
$l['magazine'] = 'Chargeur';
$l['ammo'] = 'Nombre de Munitions';
$l['firerate'] = 'Cadence de tir';
$l['damage'] = 'Dégâts';
$l['accuracy'] = 'Précision';
$l['stability'] = 'Stabilité';
$l['threat'] = 'Menace';
$l['knockdown'] = 'Puissance de KO';
$l['chargetime'] = 'Temps de charge';
$l['range'] = 'Portée';
$l['infinite'] = '∞';
$l['tops'] = 'Profils les plus vus';
$l['totalview'] = 'Nombre de vues';
...
////Melee
$l['butt'] = 'Culasse de l\'arme';
$l['butt-description'] = 'Dans les braquages à main armée, frapper les victimes avec des armes à feu est généralement plus commun que leur tirer dessus ou les poignarder. Généralement, vous frappez quelqu\'un avec la culasse d\'un fusil ou vous le frappez avec une arme de poing.<br/><br/>Ceci est l\'attaque de mélée la plus rapide.';
$l['fists'] = 'Poings';
...
$l['crimefest-more'] = 'membres supplémentaires sont requis pour débloquer';
$l['gage-gun'] = 'une arme de Gage';
$l['gensec-enemy'] = 'un nouvel ennemi parmi les unités GenSec';
$l['time-of-day'] = 'un mode Jour/Nuit';
$l['secret-unlock'] = 'le Secret';
$l['nothing'] = 'Rien';
