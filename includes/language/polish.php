...
$l['gear'] = 'Gear';
$l['levelmenu'] = 'Poziomy';
$l['weaponlist'] = 'Lista Broni';
$l['masklist'] = 'Lista Masek';
$l['armorlist'] = 'Lista Pancerzy';
$l['gadgetlist'] = 'Lista Gadżetów';
$l['heistlist'] = 'Lista Napadów';
$l['escapelist'] = 'Lista Ucieczek';
$l['levellist'] = 'Lista Poziomów';
$l['gearlist'] = 'Gear List';
//Service
$l['servicestatus'] = 'Sprawdź Status Serwisu';
$l['vanitystatus'] = 'Player Vanity Status';
$l['summarystatus'] = 'Player Summary Status';
$l['ownershipstatus'] = 'Player Ownership Status';
$l['statisticsstatus'] = 'Status Statystyk Graczy';
$l['offline'] = 'OFFLINE (Naciśnij przycisk oka po więcej informacji)';
$l['online'] = 'ONLINE';
//Tags and Warnings
$l['cflag'] = '[Oszust]';
...
////Melee
$l['butt'] = 'Kolba Broni';
$l['butt-description'] = 'W napadach z użyciem broni, częściej bije się ofiary bronią, niż nożem czy nabojem. Zazwyczaj albo uderzysz kogoś kolbą, albo zbiczujesz kogoś pistoletem.<br/><br/>Najszybsza broń do walki wręcz.';
$l['fists'] = 'Pięści';
$l['fists-description'] = 'Nie jesteś bokserem, ale nadal umiesz pożądnie walnąć. Wszystko czego potrzebujesz, to siły, szybkości i dobrego refleksu a przygrzmocisz nieźle komuś w twarz.';
$l['brass_knuckles'] = '350K Kastet';
$l['brass_knuckles-description'] = 'Bronie takie jak kastet były używane na całym świecie przez setki lat. Kastet koncentruje siłę uderzenia poprzez celowanie w mocniejszcze i mniejsze miejsca, zwiększajać szanse na poważne obrażenia. Walnij odpowiednio mocno, a zniekształcisz ofiarze kilka kości.';
$l['moneybundle'] = 'Plik Bankotów';
$l['moneybundle-description'] = 'Przechowywanie pieniędzy w plikach złączonych paskiem, jest tak stare jak same pieniądze. Bicie ludzi pieniędzmi jest czymś, co Bogaci i Znani robią od dawna.';
$l['barbedwire'] = 'Kij Baseballowy';
$l['barbedwire-description'] = 'Kij Baseballowy, którym możesz nabijać HomeRuny.';
$l['kabar'] = 'Nóż URSA';
$l['kabar-description'] = 'Nóż URSA jest mocnym, niezniszczalnym nożem bojowym z 1942. Niezawodne ostrze, ząbkowana krawędź, bez głupich żartów. Klasyk.';
$l['kampfmesser'] = 'Ostrze Kriegera';
$l['kampfmesser-description'] = 'Ostrze Kriegera jest standardowym nożem Niemieckiej Armii. Dobra rączka oraz ostrze Tanto robią z niego idealny wybór jako nóż do walki.';
$l['gerber'] = 'Nóż Berger';
$l['gerber-description'] = 'Nóż Berger jest popularnym nożem z rozkładaną rączką. Rozmiar, lekkość i materiały wysokiej jakości tworzą z nieka szybką i niebezpieczną broń.';
$l['rambo'] = 'Nóż Trautman';
...
$l['tomahawk'] = 'Tomahawk Przetrwania';
...
$l['dingdong'] = 'Młot Do Burzenia Ding Dong';
...
$l['baseballbat'] = 'Kij Bejsbolowy';
$l['baseballbat-description'] = '';
$l['briefcase'] = 'Walizka 50 Błogosławieństw';
$l['briefcase-description'] = '';
$l['cleaver'] = 'Tasak';
$l['cleaver-description'] = '';
$l['fireaxe'] = 'Topór Strażacki';
$l['fireaxe-description'] = '';
$l['machete'] = 'Maczeta';
$l['machete-description'] = '';
$l['kabartanto'] = 'Nóż Ursa Tanto';
$l['kabartanto-description'] = '';
$l['toothbrush'] = 'Sczoteczka Nova\'s Shank';
$l['toothbrush-description'] = '';
$l['chef'] = 'Nóż Psychola';
$l['chef-description'] = '';
////Grenades
$l['frag-grenade'] = 'Granat';
////Gadgets
$l['ammo_bag'] = 'Torba z Amunicją';
...
$l['doctor_bag'] = 'Torba z Lekarstwami';
...
$l['armor_kit'] = 'Torba z Panczerzem';
...
$l['bodybags_bag'] = 'Walizka z Torbami na Ciała';
...
////Armor
$l['level_1'] = 'Dwu Cześciowy Garnitur';
