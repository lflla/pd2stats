...
////
$l['language'] = 'Polish';
$l['author'] = 'Siergiej, Punished Snake';
...
$l['meta-description'] = 'Witaj na Payday 2 Statistics, stronie z łatwym dostępem to statystyk każdego gracza Payday 2.';
$l['meta-language'] = 'Polish';
$l['meta-keywords'] = 'Payday 2, Profile, Statystyki, pd2stats.com';
//Index and Search
$l['welcome'] = 'Witaj na Payday 2 Statistics!';
$l['search-txt'] = 'Szukaj';
$l['search-msg'] = 'Podaj link do profilu Steam, Niestandarową nazwę ID Profilu lub jego numer.';
$l['search-button'] = 'Zabierz mnie stąd!';
//Menu
$l['steamgroup'] = 'Grupa Steam';
$l['feedback'] = 'Opinie';
$l['notice'] = 'Ogłoszenia';
//Tags and Warnings
$l['cflag'] = '[Oszust]';
...
$l['dlc-item-end'] = '!';
$l['infamous-item'] = 'TO JEST NIESŁAWNA RZECZ';
$l['custom-item'] = 'TO JEST NIESTANDARDOWA RZECZ STWORZONA PRZEZ';
//Errors
$l['error-text1'] = 'Niewykorzystywane ID!';
$l['error-text2'] = 'JESTEM ERROREM';
...
$l['error-end'] = 'Podaj link do profilu Steam, Niestandarową nazwę ID Profilu lub jego numer.';
//Profile
$l['meta-private'] = 'ustawił swój profil na Prywatny i tylko podstawowe infromacje są pokazane.';
$l['steam-link'] = 'Link do Profilu Steam';
$l['profile-link'] = 'Lind do Profilu PD2 STATS';
//Feedback
$l['question-box'] = 'Pytania i opinie';
$l['feedback-meta'] = 'Tu możesz zostawiś swoją opinię na temat Payday 2 Statistics.';
//Stats Page
$l['comments'] = 'Komentarze';
$l['comments-no-script'] = 'Włącz JavaScript żeby zobaczyć';
$l['comments-powered'] = 'Komentarze w oparciu o';
$l['tips'] = 'Wskazówki';
$l['tips-start'] = 'Czy wiesz że możesz też wziąć link do profilu Steam:';
$l['tips-mid'] = 'I zamienić część url?';
$l['credits'] = 'Twórcy';
$l['skilltrees'] = 'Drzewka Umiejętności';
$l['skilltrees-help'] = 'To jest konfiguracja umiejętności, której gracz używał, kiedy dane zostały wysłane z gry do Steama. Czasami drzewko umiejętności jest całe odblokowane. Jak narazie nie wiadomo, co powoduje ten błąd. Jednakże, można urzyć HoxHuda w celu zrewalidowania danych o umiejętnościach.Dodatkowo informujemy, że liczba wszystkich dostępnych Punktów Umiejętności, może być zła z powodu rzadkiego błędu dotyczącego szybkiego levelowania.';
$l['mastermind'] = 'Mózg';
$l['technician'] = 'Technik';
$l['ghost'] = 'Duch';
$l['enforcer'] = 'Goryl';
$l['hours'] = 'godziny';
$l['minutes'] = 'minuty';
$l['level'] = 'Poziom Payday 2:';
$l['playtime'] = 'Czas Gry';
$l['skillpoints'] = 'Punkty Umiejętności';
$l['skillpoints8'] = 'Punkty Umiejętności';
$l['skillpoint'] = 'Punkt Umiejętności';
$l['basic'] = 'Podstawa';
$l['ace'] = 'Zaawansowane';
$l['unlock'] = 'Odblokuj za';
$l['basics'] = 'Podstawy';
$l['basics-help'] = 'To są dane na temat dni. PD2 Stats śledzi je od czasów GO Bank Uptade. Licznik wskazuję wszystkie zaliczone (jak i nie zaliczone) dni (wliczając ucieczki).';
$l['risk'] = 'Poziom Trudności';
$l['days-played'] = 'Dni zagrane';
$l['total-day-start'] = 'Wliczając';
...
$l['fail'] = 'Przegrane';
$l['escape'] = 'Ucieczki';
$l['escape-help'] = 'To są dane ucieczek. Dane są śledzone od około czasu aktualizacji GO Bank. To oznacza, że obecnie liczy dni zwycięskie i przegrane.';
$l['total'] = 'Ilość Całkowita';
$l['masks'] = 'Maski';
$l['masks-help'] = 'To są dane masek. Użycia mask są wyświetlane w dniach, zawierając przegrane dni, zwycięskie dni i dni ucieczki.';
$l['usage'] = 'Użycia';
$l['name'] = 'Nazwa';
$l['armors'] = 'Pancerze';
$l['armor'] = 'Pancerz';
...
$l['melee'] = 'Broń biała';
$l['kills'] = 'Zabójstwa';
$l['percent-kills'] = '% wszystkich zabójstw';
$l['magazine'] = 'Magazynek';
$l['ammo'] = 'Całkowita Amunicja';
$l['firerate'] = 'Szybkość Ognia';
$l['damage'] = 'Obrażenia';
$l['accuracy'] = 'Celność';
$l['stability'] = 'Stabilność';
$l['threat'] = 'Zagrożenie';
$l['knockdown'] = 'Ogłuszenie';
$l['chargetime'] = 'Czas ładowania';
$l['range'] = 'Zasięg';
$l['infinite'] = '∞';
$l['tops'] = 'Najczęściej Wyświetlane Profile';
$l['totalview'] = 'Całkowita Ilość Wyświetleń';
$l['playername'] = 'Nazwa gracza';
//DLC Names
...
$l['fire'] = 'Firestarter';
$l['rats'] = 'Szczury';
$l['election'] = 'Dzień Elekcji';
$l['fourstores'] = 'Cztery Sklepy';
$l['nightclub'] = 'Klub Nocny';
$l['mallcrasher'] = 'Mallcrasher';
$l['diamond-store'] = 'Sklep z Diamentami';
$l['shadowraid'] = 'Cienisty Nalot';
$l['bank-deposit'] = 'Bank: Skrzynki Depozytowe';
$l['bank-cash'] = 'Bank: Kasa';
$l['bank-gold'] = 'Bank: Złoto';
$l['bank'] = 'Bank';
$l['go-bank'] = 'Bank GO';
$l['big-bank'] = 'Wielki Bank';
$l['jewelry-store'] = 'Sklep z Biżuterią';
$l['nightmare'] = 'Koszmar w Kryjówce';
$l['big-oil'] = 'Big Oil';
$l['ukrainian'] = 'Ukraińska Robota';
$l['transport-harbor'] = 'Transport Opancerzony: Port';
$l['transport-park'] = 'Transport Opancerzony: Park';
...
$l['escapecafenight'] = 'Cafe (Noc)';
$l['escapecafeday'] = 'Cafe (Dzień)';
$l['escapestreet'] = 'Ulica';
$l['escapeoverpass'] = 'Wiadukt';
$l['escapegarage'] = 'Garaż';
////Skilltrees
//Mastermind
...
$l['crimefest-more'] = 'potrzebuje więcej członków do odblokowania';
$l['gage-gun'] = 'Broń od Gage\'a';
$l['gensec-enemy'] = 'Wróg od GenSec';
$l['time-of-day'] = 'Warianty napadów w zależności od pory dnia';
$l['secret-unlock'] = 'Sekretne Rzeczy';
$l['nothing'] = 'Nic';
