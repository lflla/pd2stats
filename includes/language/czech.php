...
$l['title-full'] = 'Statistiky Payday 2';
$l['meta-description'] = 'VÌtejte na statistik·ch Payday 2, jednoduchÈm zp˘sobu zobrazenÌ statistik hr·Ë˘ Payday 2.';
$l['meta-language'] = '»esky';
$l['meta-keywords'] = 'Payday 2, Profily, Statistiky, pd2stats.com';
//Index and Search
$l['welcome'] = 'VÌtejte na statistik·ch Payday 2!';
$l['search-txt'] = 'Hledat';
$l['search-msg'] = 'ProsÌm vloûte odkaz na profil na steamu, vlastnÌ ID profilu nebo ËÌslo profilu.';
$l['search-button'] = 'NajÌt statistiky!';
//Menu
$l['steamgroup'] = 'Skupina na Steamu';
$l['feedback'] = 'ZpÏtn· vazba';
$l['notice'] = 'UpozornÏnÌ';
//Tags and Warnings
$l['adsblocked'] = 'Zjistili jsme, ûe pouûÌv·te software na blokov·nÌ reklam. TÌmto pom·h·te k z·niku tÈto str·nky. Na provoz pot¯ebujeme penÌze, a tÈmÏ¯ vöechny poch·zÌ z naöich reklam.';
$l['cflag'] = '[Cheater]';
$l['cflag-warning'] = 'DÌky nÏkter˝ch chyb·m hry nemusÌ toto oznaËenÌ vûdy b˝t pravdivÈ.';
$l['pflag'] = '[RodinnÈ SdÌlenÌ]';
$l['pflag-warning'] = 'znamen·, ûe hr·Ë tuto hru nevlastnÌ.';
$l['hflag'] = '[SKRYT›]';
$l['sflag'] = '[Podez¯el˝]';
$l['level-warning'] = 'Level hr·Ëe obËas nesedÌ. Overkill uû zjiöùuje proË.';
//Item Quality Texts
$l['community-item'] = 'TOTO JE KOMUNITNÕ VÃC!';
$l['dlc-item-start'] = 'TATO VÃC POCH¡ZÕ Z';
$l['dlc-item-end'] = ' ';
$l['infamous-item'] = 'TOTO JE INFAMOUS VÃC!';
$l['custom-item'] = 'TOTO JE VLASTNÕ VÃC VYTVOÿENA';
//Errors
$l['error-text1'] = 'NeplatnÈ ID!';
$l['error-text2'] = 'CHYBA';
$l['error-text3'] = 'Steam nedok·zal odpovÏdÏt vËas!';
$l['error-text4'] = 'Nebylo zad·no ID';
$l['error-text5'] = 'Neobsahuje ËÌslo profilu';
$l['error'] = 'Chyba';
$l['error-start'] = 'NÏco se pokazilo, ale vûdy to m˘ûete';
$l['error-mid'] = 'zkusit pozdÏji';
$l['error-end'] = 'ProsÌm vloûte odkaz na profil na steamu, vlastnÌ ID profilu nebo ËÌslo profilu.';
//Profile
$l['meta-private'] = 'uûivatel si nastavil profil jako soukrom˝, a zobrazuje jen z·kladnÌ informace.';
$l['steam-link'] = 'Odkaz na Steam';
$l['profile-link'] = 'Odkaz na profil';
//Feedback
$l['question-box'] = 'zpÏtn· vazba';
$l['feedback-meta'] = 'Zde m˘ûete zanechat jakÈkoliv p¯ipomÌnky o statistik·ch Payday 2.';
//Stats Page
$l['comments'] = 'Koment·¯e';
$l['comments-no-script'] = 'ProsÌm povolte JavaScript pro zobrazenÌ';
$l['comments-powered'] = 'koment·¯˘ poh·nÏn˝ch';
$l['tips'] = 'Tipy';
$l['tips-start'] = 'VÏdÏli jste, ûe m˘ûete pouûÌt odkaz na profil na steamu jako nap¯Ìklad:';
$l['tips-mid'] = 'a zmÏnit pouze Ë·st odkazu?';
$l['credits'] = 'Auto¯i';
$l['skilltrees'] = 'Skilly';
...
$l['playtime'] = 'Doba hranÌ';
$l['skillpoints'] = 'Skillpointy';
$l['skillpoints8'] = 'Skillpoint˘';
$l['skillpoint'] = 'Skillpoint';
$l['basic'] = 'Z·kladnÌ';
$l['ace'] = 'VylepöenÈ';
$l['unlock'] = 'Cena odemknutÌ';
$l['basics'] = 'Z·kladnÌ';
$l['basics-help'] = 'Toto jsou statistiky dnÌ. Zaznamen·v· data zhruba od doby vyd·nÌ GO Bank. PoËet je zobrazov·n ve dnÌch a obsahuje i ˙tÏky. To znamen·, ûe poËÌt· pouze ˙spÏönÈ a ne˙spÏönÈ dny.';
$l['risk'] = 'Risk';
$l['days-played'] = 'DnÌ uhr·no';
$l['total-day-start'] = 'Z toho je';
$l['total-day-mid'] = '˙spÏön˝ch a';
$l['total-day-end'] = 'ne˙spÏön˝ch dnÌ.';
$l['heist'] = 'Loupeûe';
$l['heist-help'] = 'Toto jsou statistiky loupeûÌ. Zaznamen·v· data zhruba od doby vyd·nÌ Updatu #32.1. ZelenÈ jsou ˙sÏönÈ, ûlutÈ jsou ˙spÏönÈ ale p¯i p¯ipojenÌ bÏhem hry a ËervenÈ jsou ne˙spÏönÈ. PrvnÌ procenta jsou poËÌt·ny pouze pro tuto loupeû a ty druhÈ jsou pro vöechny loupeûe.';
$l['sort'] = 'Se¯adit podle';
$l['win'] = 'V˝hry';
$l['dropin'] = 'P¯ipojenÌ';
$l['fail'] = 'Prohry';
$l['escape'] = '⁄tÏky';
$l['escape-help'] = 'Toto jsou data ˙tÏk˘. Zaznamen·v· data zhruba od doby vyd·nÌ GO Bank. To znamen·, ûe poËÌt· pouze ˙spÏönÈ a ne˙spÏönÈ dny.';
$l['total'] = 'Celkem';
$l['masks'] = 'Masky';
$l['masks-help'] = 'Toto jsou statistiky mask. PouûitÌ masek se zobrazuje ve dnech. PoËÌt· v˝hry, prohry i ˙tÏky.';
$l['usage'] = 'PouûitÌ';
$l['name'] = 'JmÈna';
$l['armors'] = 'BrnÏnÌ';
$l['armor'] = 'BrnÏnÌ';
$l['armor-help'] = 'Toto jsou data brnÏnÌ. Zaznamen·v· data zhruba od doby vyd·nÌ Updatu #32.1. PouûitÌ brnÏnÌ se zobrazuje ve dnech. PoËÌt· v˝hry, prohry a ˙tÏky.';
$l['times-used'] = 'PoËet pouûitÌ';
$l['concealment'] = 'KrytÌ';
$l['speed'] = 'Rychlost';
$l['dodge'] = 'Uh˝b·nÌ';
$l['steadiness'] = 'Stabilita';
$l['stamina'] = 'Stamina';
$l['gadgets'] = 'Pom˘cky';
$l['gadgets-help'] = 'Toto jsou data pom˘cek. Zaznamen·v· data zhruba od doby vyd·nÌ GO Bank. Zobrazuje poËet pouûitÌ.';
$l['weapons'] = 'ZbranÏ';
$l['weapons-help'] = 'Toto jsou data zbranÌ. Zaznamen·v· zabitÌ zhruba od doby Updatu #32.1 a pouûitÌ zhruba od doby vyd·nÌ GO Bank. Statistiky pouûitÌ zbranÌ na blÌzko zaËali b˝t poËÌt·ny po vyd·nÌ Updatu #31.2. PouûitÌ zbranÌ se zobrazuje ve dnech, vËetnÏ v˝her, proher a ˙tÏk˘.';
$l['primary'] = 'HlavnÌ';
$l['secondary'] = 'Sekund·rnÌ';
$l['melee'] = 'Na blÌzko';
$l['kills'] = 'ZabitÌ';
$l['percent-kills'] = '% celkov˝ch zabitÌ';
$l['magazine'] = 'Z·sobnÌk';
$l['ammo'] = 'Celkem munice';
$l['firerate'] = 'Rychlost st¯elby';
$l['damage'] = 'PoökozenÌ';
$l['accuracy'] = 'P¯esnost';
$l['stability'] = 'Stabilita';
$l['threat'] = 'Hrozivost';
$l['knockdown'] = 'SraûenÌ';
$l['chargetime'] = 'Doba nataûenÌ';
$l['range'] = 'Dosah';
$l['infinite'] = '0';
//DLC Names
...
$l['cloth_commander-description'] = 'Commander Crime is an American fictional character, a super-villain and the supreme leader of the criminal network C.R.I.M.E. who appears in comic books by OVERKILL Comics.<br/><br/>The character was created by now world renowned writer-editor-artist and professional badminton player Max Elmberg Sjˆholm.<br/><br/>Commander Crime made his first appearance in The Amazing Career Criminals: The PAYDAY gang gets a C.R.I.M.E. offer they can\'t refuse!';
...
$l['ironman-ace'] = 'When you melee Shield enemies, they get knocked back by the sheer force. Run and shoot ñ you can now shoot from the hip while sprinting.';
...
$l['crimefest-more'] = 'lidÌ zb˝v· do odemËenÌ';
$l['gage-gun'] = 'zbranÏ od Gage';
$l['gensec-enemy'] = 'nep¯Ìtele z GenSecu';
$l['time-of-day'] = 'noËnÌ verze pro nÏkterÈ loupeûe';
$l['secret-unlock'] = 'nÏËeho tajnÈho';
$l['nothing'] = 'niËeho';